...
export const orchestratorOutputSchema = z.object({
	sections: z
		...
		.max(5)
		.describe('An array of content sections generated for the task.'),
...
export const taskCreationSchema = z.object({
	...
	taskType: z
		.nativeEnum(taskTypeEnum)
		.describe('Type of task (lesson, homework, test, assignment, module)'),
	subjectOfferingId: z.number().describe('ID of the subject offering this task belongs to'),
	subjectOfferingClassId: z
		.number()
		.describe('ID of the subject offering class this task is assigned to'),
