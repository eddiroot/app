...
export async function seedDemoUsers(
    ...
    await db.insert(schema.userRelationship).values([
        { userId: students[0].id, relatedUserId: parents[0].id, relationshipType: relationshipTypeEnum.mother },
        { userId: students[0].id, relatedUserId: parents[1].id, relationshipType: relationshipTypeEnum.father },
        { userId: students[1].id, relatedUserId: parents[2].id, relationshipType: relationshipTypeEnum.mother },
        { userId: students[1].id, relatedUserId: parents[3].id, relationshipType: relationshipTypeEnum.father },
        { userId: students[2].id, relatedUserId: parents[4].id, relationshipType: relationshipTypeEnum.mother },
        { userId: students[2].id, relatedUserId: parents[5].id, relationshipType: relationshipTypeEnum.father }
    ]);
